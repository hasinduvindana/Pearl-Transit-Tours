...
const places = [
  {
    ...
    description: "One of Sri Lanka's largest national parks with diverse wildlife and scenic landscapes.",
    image: "/udawalawa/national-park.jpg",
  },
  {
    name: "Elephant Safari",
    description: "Thrilling safari tours to spot wild elephants, water buffalo, and other wildlife.",
    image: "/udawalawa/elephant-safari.jpg",
  },
  {
    name: "Bird Watching",
    description: "Over 200 bird species including eagles, storks, and painted storks.",
    image: "/udawalawa/bird-watching.jpg",
  },
  {
    name: "Udawalawa Reservoir",
    description: "Scenic lake perfect for boating, fishing, and viewing water birds.",
    image: "/udawalawa/reservoir.jpg",
  },
  {
    name: "Jeep Tours",
    description: "Guided jeep expeditions through dense vegetation to encounter wildlife.",
    image: "/udawalawa/jeep-tours.jpg",
  },
  {
    name: "Photography Tours",
    description: "Dedicated photo safari tours for capturing stunning wildlife moments.",
    image: "/udawalawa/photography-tours.jpg",
  },
  {
    name: "Elephant Transit House",
    description: "Sanctuary caring for orphaned and injured elephants during rehabilitation.",
    image: "/udawalawa/elephant-transit-house.jpg",
  },
  {
    name: "Sunset Views",
    description: "Breathtaking sunset points overlooking the park and reservoir.",
    image: "/udawalawa/sunset-views.jpg",
  },  
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Udawalawa National Park is a wildlife haven in the central south region of Sri Lanka. 
        This expansive sanctuary is home to wild elephants, buffalo, sambar deer, and over 200 bird species. 
        Spanning vast grasslands and water bodies, Udawalawa offers thrilling safari experiences and excellent opportunities 
        for wildlife photography, birdwatching, and nature immersion in one of Asia&apos;s most biodiverse ecosystems.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Udawalawa</h2>
