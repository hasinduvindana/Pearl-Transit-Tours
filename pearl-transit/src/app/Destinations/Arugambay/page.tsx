...
const places = [
  {
    ...
    description: "Stunning sandy beach famous for surfing and golden sunsets.",
    image: "/arugambay/arugambay-beach.jpg",
  },
  {
    name: "Surfing Spots",
    description: "Consistent waves and reef breaks ideal for all surfing levels.",
    image: "/arugambay/surfing.jpg",
  },
  {
    name: "Lagoon Tour",
    description: "Boat tour through mangrove-lined lagoons spotting birds and wildlife.",
    image: "/arugambay/lagoon.jpg",
  },
  {
    name: "Pasikudah Bay",
    description: "Nearby pristine bay with calm, shallow waters perfect for swimming.",
    image: "/arugambay/pasikudah-bay.jpg",
  },
  {
    name: "Dutch Fort Ruins",
    description: "Historic colonial fort remains with archaeological significance.",
    image: "/arugambay/dutch-fort.JPG",
  },
  {
    name: "Snorkeling & Diving",
    description: "Explore vibrant coral reefs and marine biodiversity.",
    image: "/arugambay/snorkeling.jpg",
  },
  {
    name: "Fishing Village",
    description: "Experience authentic local fishing culture and village life.",
    image: "/arugambay/fishing-village.jpg",
  },
  {
    name: "Arugambay Rock",
    description: "Scenic rocky outcrop ideal for photography and meditation.",
    image: "/arugambay/arugambay-rock.jpg",
  },  
  {
    name: "Sunset Point",
    description: "Peaceful spot for evening views and seaside relaxation.",
    image: "/arugambay/sunset-point.jpg",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Arugambay is a hidden gem on Sri Lanka&apos;s east coast, renowned for its world-class surfing, pristine beaches, 
        and laid-back backpacker vibe. Surrounded by lagoons, mangroves, and historic ruins, this coastal paradise offers 
        perfect waves, authentic fishing villages, and a tranquil escape from crowds. Experience both adventure and serenity 
        in this untouched tropical haven.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Arugambay</h2>
