...
const places = [
  {
    name: "Gregory Lake",
    description: "A scenic lake surrounded by lush green hills and cool mountain air.",
    image: "/nuwara-eliya/gregory_lake.jpg",
  },  
  {
    name: "Hakgala Botanical Garden",
    description: "A beautiful garden featuring diverse plant species and colorful flowers.",
    image: "/nuwara-eliya/hakgala.jpg",
  },  
  {
    name: "Post Office",
    description: "A charming colonial-era post office, one of the oldest buildings in the city.",
    image: "/nuwara-eliya/post-office.jpg",
  },
  {
    name: "Victoria Park",
    description: "A peaceful park perfect for leisurely walks and relaxation.",
    image: "/nuwara-eliya/victoria-park.jpg",
  },
  {
    name: "Tea Plantations",
    description: "Visit sprawling tea estates and learn about Ceylon tea production.",
    image: "/nuwara-eliya/tea-plantation.jpg",
  },
  {
    name: "Lover's Leap",
    description: "A dramatic waterfall and viewpoint with an enchanting local legend.",
    image: "/nuwara-eliya/lovers-leap.jpg",
  },
  {
    name: "St. Clair's Falls",
    description: "Majestic twin waterfalls cascading down the misty mountains.",
    image: "/nuwara-eliya/st-clairs-falls.jpg",
  },
  {
    name: "Horton Plains",
    description: "A stunning national park with World's End viewpoint and unique cloud forests.",
    image: "/nuwara-eliya/horton-plains.jpg",
  },
  {
    name: "Ambewela Farms",
    description: "Experience authentic farm life and taste fresh organic produce in a serene setting.",
    image: "/nuwara-eliya/ambewela-farms.jpg",
  },
  {
    name: "Bomburu Ella",
    description: "A hidden gem waterfall surrounded by lush greenery and natural beauty.",
    image: "/nuwara-eliya/boburu-ella.jpg",
  },  
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Nuwara Eliya, the &quot;City of Lights,&quot; is a charming hill station nestled in the heart of Sri Lanka&#39;s central highlands. 
        Known for its cool climate, misty mountains, and colonial charm, it offers a perfect escape from the tropical heat. 
        With stunning tea plantations, scenic viewpoints, and beautiful gardens, Nuwara Eliya is a must-visit destination 
        for nature lovers and adventure seekers alike.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Nuwara Eliya</h2>
