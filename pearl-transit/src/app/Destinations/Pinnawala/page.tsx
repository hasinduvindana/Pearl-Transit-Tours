...
const places = [
  {
    ...
    description: "Home to rescued and orphaned elephants with daily bathing and feeding times.",
    image: "/pinnawala/elephant-orphanage.jpg",
  },
  {
    name: "Elephant Bathing",
    description: "Watch trained elephants bathe in the river in this heartwarming experience.",
    image: "/pinnawala/elephant-bathing.jpg",
  },
  {
    name: "Baby Elephant Feeding",
    description: "Interact with young calves during feeding sessions throughout the day.",
    image: "/pinnawala/baby-elephant.jpg",
  },
  {
    name: "Elephant Trekking",
    description: "Ride through scenic trails on the back of friendly elephants.",
    image: "/pinnawala/elephant-trekking.jpg",
  },
  {
    name: "Malu Ganga River",
    description: "Picturesque river boat tours amid green landscapes and wildlife.",
    image: "/pinnawala/malu-ganga-river.jpg",
  },
  {
    name: "Local Markets",
    description: "Browse handicrafts, souvenirs, and traditional Sri Lankan artifacts.",
    image: "/pinnawala/markets.jpg",
  },
  {
    name: "Botanical Gardens",
    description: "Lush gardens showcasing tropical plants and flowering trees.",
    image: "/pinnawala/botanical-garden.jpg",
  },
  {
    name: "Bamboo Forest",
    description: "Serene bamboo groves offering peaceful nature walks and photo opportunities.",
    image: "/pinnawala/bamboo-forest.jpg",
  },
  {
    name: "Village Tours",
    description: "Experience authentic rural life and traditional farming methods.",
    image: "/pinnawala/village-tours.jpg",
  },
  {
    name: "Riverside Cafes",
    description: "Relax at scenic cafes with views of the river and elephant activities.",
    image: "/pinnawala/riverside-cafes.jpg",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Pinnawala is famous for its Elephant Orphanage, a sanctuary for rescued and orphaned elephants. 
        Set along the scenic Malu Ganga River, this destination offers unique opportunities to interact with these 
        magnificent creatures, explore lush riverside landscapes, and experience authentic village life. 
        A visit to Pinnawala promises unforgettable moments of wildlife connection and natural beauty.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Pinnawala</h2>
