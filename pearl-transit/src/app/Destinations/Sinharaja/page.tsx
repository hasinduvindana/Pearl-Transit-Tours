...
const places = [
  {
    ...
    description: "UNESCO World Heritage site with pristine tropical rainforest and endemic species.",
    image: "/sinharaja/rainforest-reserve.jpg",
  },
  {
    name: "Trekking Trails",
    description: "Well-maintained hiking paths through dense forest with varying difficulty levels.",
    image: "/sinharaja/trekking-trails.jpg",
  },
  {
    name: "Bird Watching",
    description: "Haven for ornithologists with numerous endemic bird species and tropical forests.",
    image: "/sinharaja/bird-watching.jpg",
  },
  {
    name: "Waterfall Tours",
    description: "Hidden waterfalls nestled deep within the rainforest offering refreshing dips.",
    image: "/sinharaja/waterfall-tours.jpg",
  },
  {
    name: "Endemic Species",
    description: "Encounter rare and unique species found nowhere else on earth.",
    image: "/sinharaja/endemic-species.jpg",
  },
  {
    name: "Guided Nature Walks",
    description: "Expert-led walks explaining the ecosystem, flora, and fauna of the rainforest.",
    image: "/sinharaja/guided-walks.jpg",
  },
  {
    name: "Jungle Photography",
    description: "Capture stunning wildlife and nature photography in pristine rainforest settings.",
    image: "/sinharaja/jungle-photography.jpg",
  },
  {
    name: "Stream Crossings",
    description: "Adventure through cool mountain streams and natural pools.",
    image: "/sinharaja/stream-crossing.jpg",
  },  
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Sinharaja Rainforest is Sri Lanka&apos;s most pristine and biodiverse rainforest, designated as a UNESCO World Heritage site. 
        Spanning the southwestern highlands, this ancient forest is home to hundreds of endemic plant and animal species, rare birds, 
        and unique insects found nowhere else in the world. Trekking through Sinharaja offers an immersive jungle experience, with 
        opportunities for bird watching, waterfall exploration, and connecting with one of Earth&apos;s most important ecosystems.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Sinharaja</h2>
