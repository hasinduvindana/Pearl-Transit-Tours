...
const places = [
  {
    name: "Bentota Beach",
    description: "Wide golden-sand beach ideal for swimming, sunbathing, and sunset strolls.",
    image: "/bentota/bentota-beach.jpg",
  },  
  {
    name: "Kosgoda Turtle Hatchery",
    description: "Learn about turtle conservation and see hatchlings up close.",
    image: "/bentota/kosgoda-turtle.jpg",
  },
  {
    name: "Aluthgama Kande Vihara",
    description: "Historic temple perched on a hilltop with panoramic views and spiritual significance.",
    image: "/bentota/kande-vihara.JPG",
  },
  {
    name: "AIDA Gems Bentota",
    description: "Explore Sri Lanka's precious gemstones and learn about mining and cutting techniques.",
    image: "/bentota/aida-gems.jpg",
  },
  {
    name: "Herble Spice Garden",
    description: "Walk through aromatic spice plantations and experience traditional herbal remedies.",
    image: "/bentota/spice-garden.jpg",
  },
  {
    name: "Lunuganga Estate",
    description: "Geoffrey Bawa's serene country estate blending art, architecture, and nature.",
    image: "/bentota/lunguganga.jpg",
  },
  {
    name: "Brief Garden",
    description: "Bevis Bawa's tropical garden with sculptures and lush pathways.",
    image: "/bentota/brief-garden.jpg",
  },
  {
    name: "Water Sports",
    description: "Jet skiing, windsurfing, and banana-boat rides on calm lagoon waters.",
    image: "/bentota/water-sports.jpg",
  },  
  {
    name: "Ayurveda Spas",
    description: "Relax with authentic Ayurveda treatments and herbal massages.",
    image: "/bentota/ayurveda.jpg",
  },  
  {
    name: "Galapata Vihara",
    description: "Ancient Buddhist temple featuring murals, statues, and historic stone pillars.",
    image: "/bentota/galapatha-vihara.JPG",
  },  
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1d3b] via-black to-gray-900 text-white p-3 sm:p-6 md:p-10">
      ...
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl mt-4 sm:mt-6 leading-relaxed text-justify max-w-4xl mx-auto">
        Bentota is a beloved beach getaway on Sri Lanka&apos;s southwest coast, famed for its golden sands, calm lagoon, 
        and lush riverbanks. From high-energy water sports to tranquil river safaris, Bentota blends adventure and 
        relaxation. Discover iconic Bawa estates, sea turtle conservation, Ayurveda wellness, and warm coastal hospitality 
        in this sun-kissed destination.
      </p>

      {/* Popular Places Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-8 sm:mt-10 mb-4 text-center px-2">Most Popular Places in Bentota</h2>
